...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'GroupRedirect', fields
        # ['previous_short_id', 'previous_project_slug']
        db.delete_unique(u'sentry_groupredirect', ['previous_short_id', 'previous_project_slug'])

        # Adding unique constraint on 'GroupRedirect', fields ['organization_id',
        # 'previous_short_id', 'previous_project_slug']
        db.create_unique(
            'sentry_groupredirect', [
                'organization_id', 'previous_short_id', 'previous_project_slug'])
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'GroupRedirect.organization_id'
        db.delete_column('sentry_groupredirect', 'organization_id')

        # Adding unique constraint on 'GroupRedirect', fields
        # ['previous_short_id', 'previous_project_slug']
        db.commit_transaction()
        db.execute(
            "CREATE UNIQUE INDEX CONCURRENTLY {} ON sentry_groupredirect (previous_short_id, previous_project_slug)".
            format(
                db.create_index_name(
                    'sentry_groupredirect', [
                        'previous_short_id', 'previous_project_slug']),
    ...
    models = {
        ...
        'sentry.apiapplication': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "'4250d57d06514cb792d0a36f5255e4834a9ec2006d974099b5c2259a10083cef'", 'unique': 'True', 'max_length': '64'}),
            'client_secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'d1e08c4ed2804c7885f76d964f7edb19ed13b6d1a3b144f7961628e590f38754'"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'homepage_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Usable Hornet'", 'max_length': '64', 'blank': 'True'}),
        ...
        'sentry.apigrant': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'5ecd8dabb8be47adaf2743ac088255e8'", 'max_length': '64', 'db_index': 'True'}),
            'expires_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 7, 19, 0, 0)', 'db_index': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.apitoken': {
            ...
            'application': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.ApiApplication']", 'null': 'True'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'expires_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 8, 18, 0, 0)', 'null': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'refresh_token': ('django.db.models.fields.CharField', [], {'default': "'ad454ff5a8e643e69c6bc7f3998069a08ad682c89e274ddbb821be78bed8891e'", 'max_length': '64', 'unique': 'True', 'null': 'True'}),
            'scope_list': ('sentry.db.models.fields.array.ArrayField', [], {'of': (u'django.db.models.fields.TextField', [], {})}),
            'scopes': ('django.db.models.fields.BigIntegerField', [], {'default': 'None'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'54f39086c312422592413cd5011e8aa417b6431d119442e99ad09f1ffbc5c881'", 'unique': 'True', 'max_length': '64'}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']"})
        },
        ...
        'sentry.broadcast': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 7, 26, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.groupshare': {
            ...
            'project': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.Project']"}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']", 'null': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f5d39892c36448a28fcccd8c9d0e9297'", 'unique': 'True', 'max_length': '32'})
        },
        'sentry.groupsnooze': {
        ...
        'sentry.scheduleddeletion': {
            ...
            'data': ('sentry.db.models.fields.jsonfield.JSONField', [], {'default': '{}'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_scheduled': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 8, 18, 0, 0)'}),
            'guid': ('django.db.models.fields.CharField', [], {'default': "'34035c79a4b74c6d87cea0e6e6049f99'", 'unique': 'True', 'max_length': '32'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.sentryapp': {
            ...
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'832dd26a-f47b-439b-bbee-1909c0abaf8a'", 'max_length': '64'}),
        ...
        'sentry.sentryappinstallation': {
            ...
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'4e2b0365-0e1b-4ffd-8e7d-0bc3bcce80d0'", 'max_length': '64'})
        },
        'sentry.servicehook': {
            ...
            'project_id': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'db_index': 'True'}),
            'secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'77e7a98f276a4cafa255b5c2fac2b6088e44ad19815546408f693762b409b9a1'"}),
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
        ...
        'sentry.useremail': {
            ...
            'validation_hash': ('django.db.models.fields.CharField', [], {'default': "u'JWsYjjHmGkkX9ji7KVsPNQsqOO4cJAbu'", 'max_length': '32'})
        },
        'sentry.userip': {
